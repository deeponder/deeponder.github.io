...
<img src="https://deeponder.github.io/img/microsvr.png" width="400" height="200" alt="some_text">
...
<img src="https://deeponder.github.io/img/devops.png" width="400" height="200" alt="some_text">
...
<img src="https://deeponder.github.io/img/docker-net-brige.png" width="400" height="200" alt="some_text">
1. 共享卷
2. IPC
3. localhost

## 9.2 场景2--同个node的不同pod间的容器通信 ((eth0-veth0)-(veth0-veth1)=>pod1的eth0与pod2的eth0)
<img src="https://deeponder.github.io/img/pod-net-alone.png" width="400" height="200" alt="some_text">

## 9.3 场景3--集群内不同node的容器间通信 (flannel)
<img src="https://deeponder.github.io/img/pode-net-cross-node.png" width="400" height="200" alt="some_text">
    
## 9.4 场景4--外部和集群内的容器通信（Service && Ingress）
1. Service。 enpoints DNS
<img src="https://deeponder.github.io/img/service-nodeport.png" width="400" height="200" alt="some_text">
2. Ingress的配置例子 及实践
